...
- Placeholder Handling: The default grey prompt words (like search recommendations) shown in input boxes on the screen are placeholders, indicating the input box is actually empty. Never treat them as real inputted text. If you want to input new content, just tap and type directly, absolutely no need to perform a delete operation first.
"""
)
